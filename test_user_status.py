...
class TestUserStatus(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sm.Users.create(user_id='test123', user_email='test@email.com', user_name='test', user_last_name='test-test')
    ...
    def test_add_status(self):
        ...
        status = self.status_collection.database.get(self.status_collection.database.status_id == 'test123_00002')
    ...
    def test_modify_status(self):
        ...
        result = self.status_collection.modify_status('test123_00002', 'test123', 'test modify status')
        self.assertFalse(result)
        # Test successful modify_status call
        result = self.status_collection.modify_status('test123_00001', 'test123', 'new modified status!')
        self.assertTrue(result)
        status = self.status_collection.database.get(self.status_collection.database.status_id == 'test123_00001')
    ...
    def test_delete_status(self):
        ...
        self.assertTrue(result)
        status = self.status_collection.database.get_or_none(self.status_collection.database.status_id == 'test123_00001')
